...
We are deeply grateful to the radiologists at Harvard Medical School and Massachusetts General Hospital whose clinical expertise made \medvigil\ possible. The two attending radiologists who annotated every case in parallel, the senior consolidating radiologist who adjudicated every disagreement and finalised every released field, and the independent fourth radiologist who supplied the construction-blind human reference baseline together contributed several hundred hours of clinical adjudication, ROI delineation, and trap-question authoring. Their willingness to translate deployment-grade safety judgements into a reproducible evaluation artefact is what allows \medvigil\ to serve as more than a leaderboard: every gold option, refusal letter, false-premise trap, and clinical risk tier in the released benchmark is theirs. We also thank colleagues at Massachusetts General Hospital for clinical-workflow guidance during the design of the risk-tier rubric. Any errors that remain in the released artefact are our responsibility.
