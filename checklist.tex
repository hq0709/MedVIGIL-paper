...
\item {\bf Declaration of LLM usage}
    ...
    %this research?
    \item[] Answer: \answerNA{}
    \item[] Justification: LLMs were used only for grammar and wording polish during paper writing; they are not part of the core method. Probe construction, ROI annotation, gold answers, the perturbation library, the doctor-defined refusal letters, and MCS computation are deterministic or radiologist-authored. The 16 audited VLMs are subjects of evaluation, not components of our pipeline.
    \item[] Guidelines:
    \begin{itemize}
