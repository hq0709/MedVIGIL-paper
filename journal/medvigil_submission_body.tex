...
GPT-4o is the most visually anchored ($L^{\star}=64$), Claude Sonnet 4.6
has the largest visual contribution (65.9\%$\rightarrow$9.1\%) but falls
back at $\sigma=32$, Qwen3.5-397B has the smallest contribution (40.5~pp)
with the earliest takeover, and HuatuoGPT-V 7B has the highest no-image
floor (20.6\%).
...
\begin{figure}[!tb]
  ...
  volume-clustered 95\% intervals. (b)~Where the 300 distance answers land
  against the near-uniform gold: every model collapses onto one or two
  buckets, Qwen2.5-VL-32B onto ``15'' for 298 items.}
  \label{fig:subtask}
\end{figure}
